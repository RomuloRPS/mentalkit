...
@Component({
    ...
    templateUrl: './ev-media-popover-coloquent.component.html',
    styleUrls: ['./ev-media-popover-coloquent.component.scss'],
})
export class EvMediaPopoverColoquentComponent implements OnInit {
